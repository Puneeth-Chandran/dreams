...
<Link to='/' style={{textDecoration:'none' ,color:'black'}}>Home</Link>
            ...
            <Col xxl={1} xl={1} lg={1} md={12} sm={12} className='p-3'>
<p className='mb-2  footer_h4 ' style={{color:'black'}}>
<Link to='/' style={{textDecoration:'none' ,color:'black'}}>Course</Link>
...
<Col xxl={1} xl={1} lg={1} md={12} sm={12} className='p-3'>
<p className='mb-2 footer_h4' style={{color:'black'}}>
<a href="#contact2" style={{textDecoration:'none',color:'black'}}>Email</a>
  </p>
...
<Col xxl={1} xl={1} lg={1} md={12} sm={12} className='p-3'>
<p className='mb-2 footer_h4' style={{color:'black'}}>
    <a href="#contact2" style={{textDecoration:'none',color:'black'}}>Contact Us</a>
