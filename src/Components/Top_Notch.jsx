      ...
      <div className='top_notch_container px-4 px-lg-0'>
        <Container>
          <Row>
            <Col xxl={8} xl={8} lg={8} md={12} sm={12}>
              ...
              <p className='top_notch_p'>
                Hands-On Practicality, Aligned with Current Industry Standards, <br />
                and Completed in Just <strong>3 Months!</strong>
              </p>
            </Col>
            ...
            <Col xxl={4} xl={4} lg={4} md={12} sm={12} className='mt-5'>
              <Button
                ...
                className='mt-3 download_btn pop_up_download_syllabus_btn'
                onClick={openModal}
              >
                Download syllabus
              </Button>
        ...
        <Dialog open={showModal} onClose={closeModal}>
          ...
          <DialogContent>
            ...
            <form className="form_text_field_container" onSubmit={handleFormSubmit}>
              <TextField
                id="name"
                name="name"
              ...
              <Button
                type="submit"
                className='download_btn download_Syllabus_btn'
                variant="outlined"
                startIcon={<ArrowDownwardIcon />}
              >
                Download Syllabus
        ...
        <Container>
          ...
          <Row className='justify-content-start mt-5'>
            {[Tool_image_1, Tool_image_2, Tool_image_3, Tool_image_4, Tool_image_5].map((image, index) => (
              <Col key={index} lg={2} md={4} col={6} className={`tool_image_${index + 1}_container`}>
                <div className="tool_image_icon mb-3">
                  ...
                  <div className="tool_image_container">
                    <img src={image} alt="dreamz design" className={`me-5 mb-3 tool_image_${index + 1}`} />
                  </div>
                </div>
              </Col>
            ))}
