      ...
      <Container className="mt-5">
        <Row>
          <Col xxl={6} xl={6} lg={6} md={12} sm={12}>
            <img src={Vector_1} alt="dreamz  design" className="about_image" />
          </Col>
          ...
          <Col xxl={6} xl={6} lg={6} md={12} sm={12}>
            ...
            <p className="about_p mt-4"> <span className="about_span_p">
            Established in 2021,
            </span>
              DesignDreamz Institute specializes in UI/UX
              Design training. Our customized courses ensure students are
              job-ready upon completion. We believe in practical learning,
              allowing students to make mistakes, build portfolios, and step
              confidently into the industry. Join us at DesignDreamz and see
              your UI/UX dreams come to life.
            </p>
          </Col>
        </Row>
        </Container>
...
<Container>
    ...
    >
      ...
      />
        ...
        {/* <div className="circle_png_div">
          <img src={Circle} alt=""  className="circle_png"/>
        </div> */}
        </div>
